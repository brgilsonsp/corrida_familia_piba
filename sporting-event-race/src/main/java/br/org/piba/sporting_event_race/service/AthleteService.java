...
public class AthleteService {
    ...
    private final static Logger LOGGER= LoggerFactory.getLogger(AthleteService.class);
    private final AthleteDataRepository repository;

    public AthleteService(AthleteDataRepository repository) {
        this.repository = repository;
    }

    public AthletesDTO<AthleteFullNameRegisterDTO> getListFullName(final String startName){
        ...
        return new AthletesDTO<>(athletes);
    }
